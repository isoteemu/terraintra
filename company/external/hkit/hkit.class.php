<?php
	...
	*/
	...
	class hKit
	{
		...
		protected function processNodes($items, $classes, $allow_includes=true){
		...
		protected function getNodeValue($node, $className)
		{
		...
		protected function filterBlankValues($s){
			return preg_match("/\w+/", $s);
		}
		
		
		protected function tidyThis($source)
		{
		...
		protected function loadDoc($input_xml, $fragment=false)
		{
		...
		protected function postProcess($profile, $s)
		{
		...
		protected function resolveEmail($v)
		{
			$parts	= parse_url($v[0]);
			return ($parts['path']);
		}
		...
		protected function dedupeSingles($s)
		{
		...
		protected function removeTextVals($s)
		{
